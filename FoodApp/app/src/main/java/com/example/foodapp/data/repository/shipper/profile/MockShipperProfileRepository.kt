 ...
 */
class MockShipperProfileRepository : ShipperProfileRepository {

    override fun getProfile(): ShipperProfile = ShipperProfile(
        name = "Nguyễn Văn A",
        phone = "0901234567",
    ...
    override fun getAccountItems(profile: ShipperProfile): List<ProfileMenuItem> = listOf(
    ...
    override fun getSettingsItems(): List<ProfileMenuItem> = listOf(
    ...
    override fun getOtherItems(): List<ProfileMenuItem> = listOf(
